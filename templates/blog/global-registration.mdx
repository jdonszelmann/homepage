...
A fact is that testing devex wants to make custom test frameworks a thing (<Issue name="testing-devex-team#2" />), 
...
as we thought that a feature she was working on (Externally Implementable Items; EII <Issue name="#125418" />) 
