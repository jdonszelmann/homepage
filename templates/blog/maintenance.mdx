...
I was talking to Mara ({{ github::user("m-ou-se") }}) today about what I was busy working on.
I said that I was fixing weird behavior of `#[deprecated]` attributes.
Last week {{ github::user("WaffleLapkin") }} and I discovered some subtle bugs in that.
...
I'll tag them with {{ generic::tag("maintenance") }}.
