...
Libraries such as {{ rust::krate("elsa") }} or {{ rust::krate("rpds") }} can help you write efficient datastructures,
...
Interestingly, {{ rust::krate("bumpalo") }} supports both kinds.
...
| ----------------------------------------------- | ------ | -------- | ----------------- | -------------------- | --------- | -------------- | --------- | --------- | ------------ | -------- | ----------- | -------------- |  -------------- | ----- | ----------------------------------------------------------------------------------------------- | --------- | ----------- | ------- |
| {{rust::krate("slab", true)}}                   | Single | `&mut`   | `usize`           |`usize`               | ❌        | ✅ compact[^2] | ✅        | ✅ `&`    | ❌           | ✅       | ✅          | ❌             |  ❌             | ❌    | `Vec` with Freelist                                                                             |           |             |         |
| {{rust::krate("bumpalo", true)}}                | Both   | `&`      | `&'a mut`         |`NonZero<usize>`      | ✅        | ❌             | ❌        | ❌        | ✅           | ✅       | ❌          |                |  ❌             | ❌    | Linked Arena Chunks                                                                             |           |             |         |
| {{rust::krate("sharded-slab", true)}}           | Single | `&`      | `usize`           |`usize`               | ❌        | ✅ freelist    | ✅        | ✅ `&`    | ❌           | ❌       | ❌          |                |  ✅             | ❌    | [Linked Arena Chunks](https://docs.rs/sharded-slab/0.1.7/sharded_slab/implementation/index.html)|           |             |         |
| {{rust::krate("typed-arena", true)}}            | Single | `&`      | `&'a mut`         |`NonZero<usize>`      | ✅        | ❌             | ✅        | ✅ `&mut` | ❌           | ❌       | ❌          |                |  ❌             | ❌    | Linked Arena Chunks                                                                             |           |             |         |
| {{rust::krate("slotmap", true)}}                | Single | `&mut`   | `K: Key`          |`NonZero<u64>`        | ❌        | ✅ freelist    | ✅        | ✅ `&`    | ❌           | ✅       | ❌          | ✅             |  ❌             | ❌    | `Vec` with Freelist                                                                             |           |             |         |
| {{rust::krate("id-arena", true)}}               | Single | `&mut`   | `Id`              |`usize`+`u32`         | ❌        | ❌             | ✅        | ✅ `&`    | ❌           | ✅       | ✅          |                |  ✅             | ❌    | Indexed `Vec`                                                                                   |           |             |         |
| {{rust::krate("generational-arena", true)}}     | Single | `&mut`   | `Index`           |`usize`+`u64`         | ❌        | ✅ freelist    | ✅        | ✅ `&`    | ❌           | ✅       | ✅          |                |  ❌             | ❌    | `Vec` with Freelist                                                                             |           |             |         |
| {{rust::krate("internment", true)}}             | Single | `&`      | `ArenaIntern<'a>` |`usize`               | ✅        | ❌             | ✅        | ❌        | ❌           | ❌       | ❌          |                |  🔒             | ✅    | Hashset of Boxes                                                                                |           |             |         |
| {{rust::krate("concurrent_arena", true)}}       | Single | `&`      | `ArenaArc`        |2*`u32`+`Arc`         | ✅        | ✅             | ✅        | ❌        | ❌           | ❌       | ❌          |                |  ✅ alloc may 🔒| ❌    | Reference Counted Buckets                                                                       |           |             |         |
| {{rust::krate("thunderdome", true)}}            | Single | `&mut`   | `Index`           |`NonZero<u64>`        | ❌        | ✅ freelist    | ✅        | ❌        | ❌           | ✅       | ❌          | ✅             |  ❌             | ❌    | Memory efficient {{ rust::krate("generational-arena") }}                                        |           |             |         |
| {{rust::krate("atree", true)}}                  | Single | `&mut`   | `Token`           |`NonZero<usize>`      | ❌        | ✅ freelist    | ✅        | ✅ `&`    | ❌           | ❌       | ✅          |                |  ❌             | ❌    | `Vec`-Backed Linked Tree                                                                        |           |             |         |
| {{rust::krate("multi-stash", true)}}            | Single | `&mut`   | `Key`             |`usize`               | ✅        | ❌             | ✅        | ✅ `&`    | ❌           | ✅       | ❌          |                |  ❌             | ❌    | Indexed `Vec`                                                                                   |           |             |         |
| {{rust::krate("colosseum", true)}}              | Single | `&`      | `&'a mut`         |`NonZero<usize>`      | ✅        | ❌             | ✅        | ❌        | ❌           | ❌       | ❌          |                |  🔒             | ❌    | `Mutex`ed {{ rust::krate("typed-arena") }}                                                      |           |             |         |
| {{rust::krate("gc", true)}}                     | Mixed  | glob     | `Gc`              |`usize`               | ✅        | ✅ GC          | ✅        | ❌        | ❌           | ❌       | ❌          |                |  ❌             | ❌    | [Garbage Collector](https://manishearth.github.io/blog/2015/09/01/designing-a-gc-in-rust/)      |           |             |         |
| {{rust::krate("atomic_arena", true)}}           | Single | `&mut`?? | `Key`             |2*`usize`             | ❌        | ✅ freelist    | ✅        | ✅ `&`    | ❌           | ❌       | ❌          |                |  🔒             | ❌    | `Vec`[^1]                                                                                       |           |             |         |
| {{rust::krate("gc-arena", true)}}               | Single | `&`      | `Gc<'a>`          |`NonZero<usize>`      | ✅        | ✅ GC          | ✅        | ❌        | ❌           | ✅       | ❌          |                |  ❌             | ❌    | [Garbage Collector](https://kyju.org/blog/rust-safe-garbage-collection/)                        |           |             |         |
| {{rust::krate("typed-arena-nomut", true)}}      | Single | `&`      | `&'a`             |`usize`               | ✅        | ❌             | ✅        | ✅ `&`    | ❌           | ❌       | ❌          |                |  ❌             | ❌    | Linked Arena Chunks                                                                             |           |             |         |
| {{rust::krate("typed-generational-arena",true)}}| Single | `&mut`   | `Index`           |~`usize`+`u64`        | ❌        | ✅ freelist    | ✅        | ✅ `&`    | ❌           | ✅       | ✅          | ✅             |  ❌             | ❌    | Various backings with Freelist[^3]                                                              |           |             |         |
| {{rust::krate("compact_arena", true)}}          | Single | `&mut`   | `IdxN<'a>`        |`u32`/`u16`/`u8`      | ❌        | ❌             | ✅        | ❌        | ❌           | ✅       | ❌          |                |  ❌             | ❌    | `Vec` with "branded" indices                                                                    |           |             |         |
| {{rust::krate("blink-alloc", true)}}            | Mixed  | `&`      |`&mut (T: 'static)`|`NonZero<usize>`      | ✅        | ❌             | ✅        | ❌        | ✅           | ✅       | ❌          |                |  🔒             | ❌    | Linked Arena Chunks                                                                             |           |             |         |
| {{rust::krate("bumpalo-herd", true)}}           | Mixed  | `&`      | `&'a mut`         |`NonZero<usize>`      | ✅        | ❌             | ❌        | ❌        | ❌           | ✅       | ❌          |                |  ✅             | ❌    | Per-thread {{ rust::krate("bumpalo") }} arena                                                   |           |             |         |
| {{rust::krate("bump_scope", true)}}             | Both   | `&`      | `BumpBox<'a>`     |`NonZero<usize>`      | ✅        | ❌             | ✅        | ❌        | ✅           | ✅       | ❌          |                |  ✅             | ❌    | Linked Arena Chunks[^4]                                                                         |           |             |         |
| {{rust::krate("shredder", true)}}               | Mixed  | glob     | `Gc<'a>`          |`Arc`+2*`usize`       | ✅        | ✅ GC          | ✅        | ❌        | ❌           | ❌       | ❌          |                |  🔒 (spinlock)  | ❌    | Single Global GC                                                                                |           |             |         |
| {{rust::krate("erased-type-arena", true)}}      | Mixed  | `&`      | `AllocMut<'a>`    |`NonZero<usize>`+`Arc`| ✅        | ❌             | ✅        | ❌        | ❌           | ❌       | ❌          |                |  ❌             | ❌    | Linked List                                                                                     |           |             |         |
| {{rust::krate("riddance", true)}}               | Single | `&mut`   | `Id<T>`           |`u32`/`u64`           | ❌        | ✅ freelist    | ✅        | ✅        | ❌           | ❌       | ❌          |                |  ❌             | ❌    | `Vec` with Freelist                                                                             |           |             |         |
| {{rust::krate("drop-arena", true)}}             | Single | `&`      | `DropBox<'a>`     |`NonZero<usize>`      | ✅        | ✅ freelist    | ✅        | ❌        | ❌           | ❌       | ❌          |                |  ❌             | ❌    | {{ rust::krate("typed-arena") }} + free list                                                    |           |             |         |
| {{rust::krate("elise", true)}}                  | Mixed  | glob     | `Gc<'a>`          |`usize`               | ✅        | ✅ GC          | ✅        | ❌        | ❌           | ❌       | ❌          |                |  🔒             | ❌    | Single Global GC                                                                                |           |             |         |
| {{rust::krate("hato", true)}}                   | Mixed  | `&mut`   | `Handle`          |`u32`+`u32`           | ❌        | ✅ freelist    | ❌        | ❌        | ❌           | ❌       | ❌          | ❌             |  🔒             | ❌    | `Vec`s of bitwise-copyable objects grouped by type                                              |           |             |         |
...
[^3]: Seems to be a fork of sorts of {{ rust::krate("generational-arena") }}. Supports many more types of backing storage including more space-efficient ones.
