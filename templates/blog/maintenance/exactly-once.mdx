...
That's what I proposed in <Issue name="libs-team#676" />, 
...
The implementation is rather trivial, this is the PR if you're interested anyway: <Pr name="#149270" />.
...
Only 3 weeks ago <User name="amanieu" /> opened the stabilization PR for a feature called `supertrait_item_shadowing` <Pr name="rust-lang/rust#148605" />
