...
So, [Rémy](https://github.com/lqd) downloaded the 20 000 most downloaded crates from `crates.io`, and measured how much slower the new solver compiled it compared to the old solver.
