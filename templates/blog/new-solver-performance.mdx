...
We run these benchmarks on every single merge into rust's main branch, providing valuable statistics. However, this set of benchmarks will always be slightly synthetic. So [Rémy](https://github.com/lqd) started doing a crater-like run, but for performance.
