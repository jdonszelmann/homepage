...
| Crate                                           | Type   | Takes    | Gives Out         | Deref Key | Reuse Mem      | Runs Drop | Iteration | Collections  | `no_std` | no `unsafe` | ABA mitigation |  concurrent     | dedup |   Approach                                                                                      | Downloads | Last Update | Version |
| ----------------------------------------------- | ------ | -------- | ----------------- | --------- | -------------- | --------- | --------- | ------------ | -------- | ----------- | -------------- |  -------------- | ----- | ----------------------------------------------------------------------------------------------- | --------- | ----------- | ------- |
...
| <Crate name="id-arena" large />                 | Single | `&mut`   | `Id`              | ❌        | ❌             | ✅        | ✅ `&`    | ❌           | ✅       | ✅          |                |  ✅             | ❌    | Indexed `Vec`                                                                                   |           |             |         |
...
| <Crate name="thunderdome" large />              | Single | `&mut`   | `Index`           | ❌        | ✅ freelist    | ✅        | ❌        | ❌           | ✅       | ❌          | ✅             |  ❌             | ❌    | Memory efficient <Crate name="generational-arena"/>                                             |           |             |         |
...
| <Crate name="blink-alloc" large />              | Mixed  | `&`      |`&mut (T: 'static)`| ✅        | ❌             | ✅        | ❌        | ✅           | ✅       | ❌          |                |  🔒             | ❌    | Linked Arena Chunks                                                                             |           |             |         |
| <Crate name="bumpalo-herd" large />             | Both   | `&`      | `&'a mut`         | ✅        | ❌             | ❌        | ❌        | ❌           | ✅       | ❌          |                |  ✅             | ❌    | Per-thread <Crate name="bumpalo" /> arena                                                       |           |             |         |
...
| <Crate name="riddance" large />                 | Single | `&mut`   | `Id<T>`           | ❌        | ✅ freelist    | ✅        | ✅        | ❌           | ❌       | ❌          |                |  ❌             | ❌    | `Vec` with Freelist                                                                             |           |             |         |
