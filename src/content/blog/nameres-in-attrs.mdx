...
description: |
    ...
    why specifically resolving the definition of a path in an attribute and was near impossible, 
...
Let'sv start with some context.
...
This means that there wasn't no type called `hir::Attribute`.
...
This servers as an exhaustive list of every possible built-in attribute.
