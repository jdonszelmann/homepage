...
To support custom test frameworks, we at least want a way register items from various modules within a single crate.
...
#[global_registry]
const MY_ROUTES: Registry<Route>;
...
To a user's perspective, it looks like tests are somewhat magically collected, and I actually think that's alright.
